...
c
  ...
  240 format('***********Passed Test*********')
      ...
      open(unit=10,file='testgridsz32_f.txtout',status="UNKNOWN")
...
c
      ...
      write(*,*)'=================='
      gdfid2 = he5_gdopen("grid2sz32.he5",HE5F_ACC_TRUNC)
      if (gdfid2 .lt. zero) then
         ...
         write(10,*)' '
         write(10,240)
         write(10,*)'gdfid2 = he5_gdopen(grid2sz32.he5",HE5F_ACC_TRUNC)'
         write(10,*)'Value returned by he5_gdopen ', gdfid2
         write(*,*)'gdfid2 = he5_gdopen(grid2sz32.he5",HE5F_ACC_TRUNC)'
         write(*,*)'Value returned by he5_gdopen ', gdfid2
      endif
      write(*,*)' '
      write(10,*)' '
       gdfid3 = he5_gdopen("grid3sz32.he5",HE5F_ACC_TRUNC)
      if (gdfid3 .lt. zero) then
         ...
         write(10,*)' '
         write(10,240)
      write(10,*)'gdfid3 = he5_gdopen("grid3sz32.he5",HE5F_ACC_TRUNC)'
      write(10,*)'Value returned by he5_gdopen ', gdfid3
      write(*,*)'gdfid3 = he5_gdopen("grid3sz32.he5",HE5F_ACC_TRUNC)'
      write(*,*)'Value returned by he5_gdopen ', gdfid3
      endif
      write(*,*)' '
      write(10,*)' '

      gdfid = he5_gdopen('gridsz32.he5',HE5F_ACC_TRUNC)
      if (gdfid .lt. zero) then
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'Opening file gridsz32.he5'
         write(10,*)'Opening file gridsz32.he5'
         write(10,*) 'gdfid = he5_gdopen("gridsz32.he5",HE5F_ACC_TRUNC)'
         write(10,*) 'File id returned from he5_gdopen ', gdfid
         write(*,*) 'gdfid = he5_gdopen("gridsz32.he5",HE5F_ACC_TRUNC)'
...
c
      ...
      gdfid = he5_gdopen('gridsz32.he5',HE5F_ACC_RDWR)
      if (gdfid .lt. zero) then
         write(*,230)
         write(10,230)
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'gdfid = he5_gdopen("gridsz32.he5",HE5F_ACC_RDWR)'
         write(10,*)'gdfid = he5_gdopen("gridsz32.he5",HE5F_ACC_RDWR)'
      ...
      gdfid3 = he5_gdopen('grid3sz32.he5',HE5F_ACC_RDWR)
      if (gdfid3 .lt. zero) then
         write(*,230)
         write(10,230)
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'gdfid3 = he5_gdopen("grid3sz32.he5",HE5F_ACC_RDWR)'
         write(10,*)'gdfid3 = he5_gdopen("grid3sz32.he5",HE5F_ACC_RDWR)'
         write(*,*)'Grid file id returned by he5_gdopen ',gdfid
         write(10,*)'Grid file id returned by he5_gdopen ',gdfid
      endif
      write(10,*)' '
...
c
      ...
      lstatus = he5_gdinqgrid('gridsz32.he5',grdnames,strbufsize)
     ...
     1grdnames,strbufsize)'
      ...
      lstatus = he5_gdinqgrid('grid3sz32.he5',grdnames,strbufsize)
      if (lstatus .lt. zero) then
         write(*,230)
         write(10,230)
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'lstatus=he5_gdinqgrid("grid3sz32.he5",
     1grdnames,strbufsize)'
         write(*,*)'Names of grids ',grdnames
         write(*,*)'Number of grids ',lstatus
         write(*,*)'Size of names of grids ',strbufsize
         write(10,*)'lstatus=he5_gdinqgrid("grid3sz32.he5",
     1grdnames,strbufsize)'
         write(10,*)'Names of grids ',grdnames
         write(10,*)'Number of grids ',lstatus
         write(10,*)'Size of names of grids ',strbufsize
