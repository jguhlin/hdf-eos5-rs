...
c
  ...
  240 format('***********Passed Test*********')
      ...
      open(unit=10,file='testgrid_f.txtout', status = "UNKNOWN")
...
c
      ...
      write(*,*)'======================'
      gdfid2 = he5_gdopen("grid2fortran64",HE5F_ACC_TRUNC)
      if (gdfid2 .lt. zero) then
         ...
         write(10,*)' '
         write(10,240)
         write(10,*)'gdfid2=he5_gdopen("grid2fortran64",HE5F_ACC_TRUNC)'
         write(10,*)'Value returned by gdopen ', gdfid2
         write(*,*)'gdfid2=he5_gdopen("grid2fortran64",HE5F_ACC_TRUNC)'
         write(*,*)'Value returned by gdopen ', gdfid2
      endif
      write(*,*)' '
      write(10,*)' '

      gdfid = he5_gdopen('gridfortran64',HE5F_ACC_TRUNC)
      if (gdfid .lt. zero) then
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'Opening file gridfortran64'
         write(10,*)'Opening file gridfortran64'
         write(10,*)'gdfid=he5_gdopen("gridfortran64",HE5F_ACC_TRUNC)'
         write(10,*)'File id returned from gdopen ', gdfid
         write(*,*) 'gdfid=he5_gdopen("gridfortran64",HE5F_ACC_TRUNC)'
...
c
      ...
      gdfid = he5_gdopen('gridfortran64',HE5F_ACC_RDWR)
      if (gdfid .lt. zero) then
         write(*,230)
         write(10,230)
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'gdfid = he5_gdopen("gridfortran64",HE5F_ACC_RDWR)'
         write(10,*)'gdfid = he5_gdopen("gridfortran64",HE5F_ACC_RDWR)'
...
c
      ...
      lstatus = he5_gdinqgrid('gridfortran64',grdnames,strbufsize)
      if (lstatus .lt. zero) then
         ...
         write(10,*)' '
         write(10,240)
         write(*,*)'lstatus = he5_gdinqgrid("gridfortran64",grdnames,
     1strbufsize)'
         write(*,*)'Names of grids ',grdnames
         write(*,*)'Number of grids ',lstatus
         write(*,*)'Size of names of grids ',strbufsize
         write(10,*)'lstatus = he5_gdinqgrid("gridfortran64",grdnames,
     1strbufsize)'
